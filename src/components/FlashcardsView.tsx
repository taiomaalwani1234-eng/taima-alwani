...
export const FlashcardsView: React.FC<FlashcardsViewProps> = ({
  ...
  return (
    <div className="w-full h-full bg-surface-variant flex flex-col font-sans text-on-background relative overflow-hidden">
      {showTutorial && (
        <TutorialOverlay
          message="استعرض بطاقات الرؤى السيبرانية. انقر على البطاقة لقلبها وقراءة التفاصيل التقنية. يمكنك التوجه للبطاقات التالية أو السابقة، أو توليد تلميحات جديدة."
